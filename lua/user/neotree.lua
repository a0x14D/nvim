...
function M.config()
  ...
  wk.register {
    ["<leader>n"] = { "<cmd>Neotree toggle<CR>", "Explorer" },
  }
  ...
  require("neo-tree").setup {
    ...
    source_selector = {
      winbar = false,    -- when true, the source selector will be displayed in the winbar
      statusline = true, -- when true, the source selector will be displayed in the statusline
    },
  }
end
