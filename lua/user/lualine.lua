...
vim.api.nvim_set_hl(0, "SLGitIcon", { fg = "#ffc700", bg = dark_gray })
vim.api.nvim_set_hl(0, "SLTermIcon", { fg = purple, bg = gray })
vim.api.nvim_set_hl(0, "SLBranchName", { fg = "#dbe4f5", bg = dark_gray, bold = false })
vim.api.nvim_set_hl(0, "SLProgress", { fg = "#ff00ff", bg = gray })
vim.api.nvim_set_hl(0, "SLLocation", { fg = "#268aff", bg = gray })
